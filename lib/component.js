	...
	_createClass(Lifecycle, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    realProps = _objectWithoutProperties(_props, ['componentWillMount', 'componentDidMount', 'componentWillReceiveProps', 'componentWillUpdate', 'componentDidUpdate', 'componentWillUnmount', 'shouldComponentUpdate']);
